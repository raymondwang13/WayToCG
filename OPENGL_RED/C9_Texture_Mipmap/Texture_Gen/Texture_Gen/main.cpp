...
void reshape(int w, int h)
{
   ...
   glLoadIdentity();
#define BASE_LENGTH 7.0f
   if (w <= h)
      glOrtho (-BASE_LENGTH, BASE_LENGTH, -BASE_LENGTH*(GLfloat)h/(GLfloat)w, 
               BASE_LENGTH*(GLfloat)h/(GLfloat)w, -BASE_LENGTH, BASE_LENGTH);
   else
      glOrtho (-BASE_LENGTH*(GLfloat)w/(GLfloat)h, 
               BASE_LENGTH*(GLfloat)w/(GLfloat)h, -BASE_LENGTH, BASE_LENGTH, -BASE_LENGTH, BASE_LENGTH);
